defmodule SymphonyElixir.AppServerTest do
  ...
  test "app server marks MCP elicitation requests as input required" do
    test_root =
      Path.join(
        System.tmp_dir!(),
    ...
    try do
      ...
      while IFS= read -r _line; do
        ...
        case "$count" in
          ...
          3)
            ...
            printf '%s\\n' '{"id":"elicitation-1","method":"mcpServer/elicitation/request","params":{"message":"Choose an option"}}'
            ;;
          *)
            exit 0
            ;;
      ...
      issue = %Issue{
        ...
        description: "Cannot satisfy MCP elicitation input",
        state: "In Progress",
      ...
      assert payload["params"]["message"] == "Choose an option"
    after
      File.rm_rf(test_root)
    end
  end
