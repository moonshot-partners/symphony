defmodule SymphonyElixir.TestSupport do
  ...
  defp workflow_content(overrides) do
    config =
      Keyword.merge(
        [
          ...
          tracker_in_progress_states: [],
          tracker_review_state: nil,
          tracker_ready_state: nil,
          tracker_blocked_state: nil,
          tracker_done_extra_states: [],
    ...
    tracker_in_progress_states = Keyword.get(config, :tracker_in_progress_states)
    tracker_review_state = Keyword.get(config, :tracker_review_state)
    tracker_ready_state = Keyword.get(config, :tracker_ready_state)
    tracker_blocked_state = Keyword.get(config, :tracker_blocked_state)
    tracker_done_extra_states = Keyword.get(config, :tracker_done_extra_states)
    ...
    sections =
      [
        ...
        "  in_progress_states: #{yaml_value(tracker_in_progress_states)}",
        "  review_state: #{yaml_value(tracker_review_state)}",
        "  ready_state: #{yaml_value(tracker_ready_state)}",
        "  blocked_state: #{yaml_value(tracker_blocked_state)}",
        "  done_extra_states: #{yaml_value(tracker_done_extra_states)}",
        "polling:",
