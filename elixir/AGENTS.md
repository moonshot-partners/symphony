...
- Read `docs/exhaustion-modes.md` before diagnosing a "stuck" or "ran out" report — it pins the five exhaustion modes (context, OOM, turn cap, read timeout, workspace-hook retry) to their telemetry markers.
