defmodule SymphonyElixir.Orchestrator.CodexTelemetry do
  @moduledoc """
  Pure helpers that fold Codex AppServer worker updates into the
  Orchestrator's running-entry and codex_totals state. Extracted from
  Orchestrator to keep the GenServer file under the file-length warning.
  """
